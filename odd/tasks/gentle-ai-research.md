...
- Push to the user-authorized fork is allowed for persistence; no pull request, release, or publication.
...
- User authorized implementation, cloning the source repository, dependency installation, local work-unit commits, and push to the personal fork; PR/release/publication remain unauthorized.
